...
const DBNewItem = () => {
  ...
  return (
    <div className="flex items-center justify-center flex-col pt-6 px-4 w-full">
          ...
          {isLoading ? (
            ...
            <>
              {!imageDownloadURL ? (
                <>
                  <label>
                    <div className="flex felx-col items-center justify-center h-full w-full cursor-pointer">

  ...
  return (
    <header className="fixed backdrop-blur-md z-50 inset-x-0 top-0 flex items-center justify-between px-12 md:px-20 py-6">
      <NavLink to={"/"} className="flex items-center justify-center gap-4">
        ...
        {/* <p className="font semi-bold text-xl">FoodKart</p> */}
      </NavLink>
      ...
      <nav className="flex items-center justify-center gap-8">
        ...
        <motion.div {...buttonClcik} className="relative cursor-pointer">
          ...
          <div className="w-6 h-6 rounded-full bg-red-500 flex items-center justify-center absolute -top-4 -right-1">
            <p className="text-primary text-base font-semi-bold">2</p>
          </div>
        </motion.div>
            ...
            >
              ...
              {isMenu && (
                <motion.div
                  ...
                  className="px-6 py-4 w-48 bg-lightOverlay backdrop-blur-md shadow-md absolute top-12 right-0 flex flex-col gap-4"
                >
                  <Link
